...
# This script is not originally mine it is from arosado- I simply modified it to fit my needs.
# Simply drop the python file your push_swap folder next to your compiled push_swap and 
# ------run python3 pyviz.py "numbers" --------   in school laptops otherwise go to
# https://github.com/pulgamecanica/42Course/blob/main/42Core/push_swap/viz.py for more info.
...
class PsGui:
    def __init__(self, master):
        ...
        self.listbox = Listbox(self.toolframe, bg='black', fg='white',
    ...
    def speed_up(self):
        if self.speed == 0:
            ...
            self.speed /= 2
        self.speedmeter.config(text='frame rate = {:.2e}'.format(self.speed))
